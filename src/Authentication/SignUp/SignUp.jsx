...
const SignUp = () => {
  ...
  useEffect(() => {
    if (success) toast.success("Sign up successfully");
  }, [success]);
  ...
  return (
    <div className="bg-[#e0f6fa] mt-17 dark:bg-gray-900 min-h-screen flex items-center justify-center py-10 px-4">
      <div className="w-full max-w-md space-y-4 p-6 rounded-2xl shadow-lg bg-white dark:bg-gray-800 transition-colors">
        <div className="text-center">
          <div className="w-12 h-12 bg-[#ADE8F4] dark:bg-sky-600 rounded-xl flex items-center justify-center mx-auto mb-3">
            <ShieldIcon />
          </div>
          <h2 className="text-3xl font-bold text-[#03045E] dark:text-gray-100">Sign Up</h2>
          <p className="text-[#03045E] dark:text-gray-300 mt-1">Create your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          {/* Photo URL */}
          <div>
            <label htmlFor="photoURL" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Photo URL</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400 dark:text-gray-500">
                <AtSignIcon />
              </div>
        ...
        <p className="text-center text-gray-700 dark:text-gray-300 text-sm mt-2">
          ...
          <Link to="/login" className="font-bold text-gray-900 dark:text-gray-100 hover:text-blue-700 dark:hover:text-sky-400 transition-colors">
            Login
          </Link>
        </p>
      </div>

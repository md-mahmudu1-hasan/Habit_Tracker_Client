...
const HabitDetails = () => {
  ...
  return (
    <motion.div
      className="bg-[#e0f6fa] dark:bg-slate-900 min-h-screen py-10"
    ...
    >
      ...
      >
        ...
        <div className="mb-4">
          ...
          <div className="w-full bg-gray-200 dark:bg-slate-700 h-4 rounded-full">
            <div
              className="bg-blue-500 dark:bg-sky-500 h-4 rounded-full transition-all"
        ...
        <div className="flex items-center mb-6">
          <img
            ...
            className="w-12 h-12 rounded-full mr-3 border border-gray-300 dark:border-slate-600"
          />
          <div>

...
const AddHabit = () => {
  ...
  return (
    <div className="min-h-screen mt-15 flex justify-center items-center bg-gradient-to-br from-[#CAF0F8] to-[#90E0EF] py-10 px-4">
      <div className="bg-white shadow-2xl rounded-2xl p-8 w-full max-w-2xl border border-[#90E0EF]">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="text-center mt-6">
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-[#00B4D8] to-[#0077B6] text-white font-semibold rounded-lg hover:scale-[1.02] transition-transform"
            >
              Add Habit
            </button>
          </div>
